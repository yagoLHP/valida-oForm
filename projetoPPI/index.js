...
server.get("/", (req, res) => {
    res.send(`
        ...
        <html>
            <head>
            <meta charset="UTF-8"/> npx kill-port 1010
...
server.get("/cadastroUsuario", (req, res) => {
    res.send(`
        ...
        <html>
            ...
            <body>
              ...
              <div class="col-md-4">
                ...
                <div class="input-group has-validation">
                  ...
                  <input type="text" placeholder="ex: Gabigol, Ronaldinho" class="form-control" id="nomeF" name="nomeF" aria-describedby="inputGroupPrepend">
                </div>
              </div>
            ...
            <input type="text" class="form-control" placeholder="(00)00000-0000" id="tel" name="tel">
            </div>
...
listaUsuarios.push({cnpj: cnpj, razaoSocial: razaoSocial, nomeF: nomeF, end: end, city: city, uf: uf, cep: cep, email: email, tel: tel}); 
res.redirect('/listaUsuarios');
}
else{
    let conteudo = `... seu código do formulário com mensagens de erro ...`; 
    res.send(conteudo);
}
});
                ...
                <table class="table table-striped table-hover">
                   ...
                   for(let i = 0; i < listaUsuarios.length; i++) { 
                    ...
                    conteudo += `
                        ...
                        conteudo += `<tr>
                                        <td colspan="9"><strong>Número total de jogadores: ${contP}</strong></td>
                                    </tr>`
    conteudo += `</tbody>
                </table>
            </div>
